...
const ExpenseTypeCreateUpdate = () => {
    ...
    const SaveChange = async () => {
        if(IsEmpty(FormValue.ExpenseTypeName)){
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-4 p-2">
                                    ...
                                    <input onChange={(e)=>{store.dispatch(OnChangeExpenseTypeInput({Name:"ExpenseTypeName",Value:e.target.value}))}} value={FormValue.ExpenseTypeName} className="form-control form-control-sm" type="text"/>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-4 p-2">
