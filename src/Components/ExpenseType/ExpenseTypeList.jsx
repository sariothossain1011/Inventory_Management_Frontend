                                            ...
                                            <div className="table-responsive table-section">
                                                <table className="table ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Expense Type Name</td>
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr>
                                                                ...
                                                                <td><p className="text-xs text-start">{item.ExpenseTypeName}</p></td>
