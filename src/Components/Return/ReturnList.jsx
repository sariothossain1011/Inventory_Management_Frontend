                                            ...
                                            <div className="table-responsive table-section">
                                                <table className="table ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">CustomerID</td>
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <Link to={`/ReturnCreateUpdatePage?id=${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
