...
import { DeleteSaleRequest, SaleListRequest } from '../../APIRequest/SalesAPIRequest';
const SaleList = () => {
                                            ...
                                            <div className="table-responsive table-section">
                                                <table className="table ">
                                                    ...
                                                    <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">#No</td>
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Customer ID</td>
                                                        ...
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Created Date</td>
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr>
                                                                ...
                                                                <td><p className="text-xs text-start">{item.CustomerID}</p></td>
                                                                <td><p className="text-xs text-start">{item.VatTax}</p></td>
                                                                <td><p className="text-xs text-start">{item.Discount}</p></td>
                                                                <td><p className="text-xs text-start">{item.OtherCost}</p></td>
                                                                <td><p className="text-xs text-start">{item.ShippingCost}</p></td>
                                                                <td><p className="text-xs text-start">{item.GrandTotal}</p></td>
                                                                <td><p className="text-xs text-start">{moment(item.CreatedDate).format('MMMM Do YYYY')}</p></td>
                                                                <td>
                                                                    <Link to={`/SalesCreateUpdatePage?id=${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
